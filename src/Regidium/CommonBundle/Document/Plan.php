...
class Plan
{
    ...
    /**
     * @MongoDB\ReferenceMany(targetDocument="Regidium\CommonBundle\Document\Client", mappedBy="plan")
     */
    protected $clients;
     ...
     */
    public function addClient(\Regidium\CommonBundle\Document\Client $client)
    {
        $this->clients[] = $client;
    }
     ...
     * @param Regidium\CommonBundle\Document\Client $client
     */
    public function removeClient(\Regidium\CommonBundle\Document\Client $client)
    {
